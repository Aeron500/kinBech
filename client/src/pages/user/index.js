...
const Home = ()=> {
  ...
  const router= useRouter();
    ...
    return (
        ...
        <CustomDrawer/>
       <section classNameName="text-gray-400 bg-gray-900 body-font">
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div classNameName="mt-4">
          <h3 classNameName="text-gray-500 text-xs tracking-widest title-font mb-1">CATEGORY</h3>
          <h2 classNameName="text-white title-font text-lg font-medium">The 400 Blows</h2>
          <p classNameName="mt-1">$18.40</p>
        </div>
      </div>
    </div>
  </div>
